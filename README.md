...
| **Read-only scopes** | `AuditLogsQuery.Read.All` and `SensitivityLabel.Read` on Microsoft; `admin.reports.audit.readonly` on Google. None of them can mutate tenant state. |
